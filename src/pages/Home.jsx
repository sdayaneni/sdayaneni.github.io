        ...
        <div className = "home">
            ...
            <div className = "personalLinks">
                <ul>
                    ...
                    <button onClick = {() => window.open("https://www.linkedin.com/in/siddharth-dayaneni-025119262", '_blank', 'noopener, noreferrer')} className = "Link-button fa fa-brands fa-linkedin" href = "https://www.linkedin.com/in/siddharth-dayaneni-025119262"/>
